...
function Install-DreamSkinBaseTheme {
  ...
  try {
    ...
    $settings = [ordered]@{
      ...
      appearanceLightChromeTheme = 'appearanceLightChromeTheme = { accent = "#20BCC3", contrast = 64, fonts = { code = "Cascadia Code", ui = "Microsoft YaHei UI" }, ink = "#164B59", opaqueWindows = true, semanticColors = { diffAdded = "#BCEBD6", diffRemoved = "#F6BDD7", skill = "#B7A5EE" }, surface = "#F7FFFF" }'
    }
