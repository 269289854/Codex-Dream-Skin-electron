...
describe('CodexService operation queue', () => {
  ...
  it('keeps identical renderer payload versions stable and changes them with content', async () => {
    ...
    expect(first.script).toContain('"conversationBubbles":{"visible":false,"user":{"mode":"none","corners":null,"bodyFill":null,"borderColor":"transparent","borderWidth":0,"borderRadius":14,"ornamentSize":0,"ornamentOutset":0,"contentPadding":20,"contentInsets":{"top":20,"right":20,"bottom":20,"left":20}}')
    expect(first.script).toContain('"codex":{"mode":"none","corners":null,"bodyFill":null,"borderColor":"transparent","borderWidth":0,"borderRadius":14,"ornamentSize":0,"ornamentOutset":0,"contentPadding":20,"contentInsets":{"top":20,"right":20,"bottom":20,"left":20}}')
