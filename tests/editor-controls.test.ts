...
describe('editor appearance controls', () => {
  ...
  it('reuses one imported font across font slots', () => {
    ...
    act(() => root.render(React.createElement(FontControl, { slot: 'brandSubtitle', profile, onChange, onImport })))
    ...
    const importButton = container.querySelector<HTMLButtonElement>('button[title="为品牌副标题导入字体"]')
