...
describe('renderer home DOM adaptation', () => {
  ...
  it('renders brand copy as text and keeps the sidebar mode icon idempotent and removable', () => {
    ...
    const newTaskAction = newTaskRow?.querySelector('[data-dream-sidebar-nav="newTask"]')
    ...
    expect(newTaskRow?.classList.contains('dream-sidebar-nav-newTask')).toBe(false)
    expect(newTaskAction?.classList.contains('dream-sidebar-nav-newTask')).toBe(true)
    expect(newTaskAction?.classList.contains('dream-sidebar-nav-newTask-selected')).toBe(true)
    ...
    expect(newTaskAction?.classList.contains('dream-sidebar-nav-newTask')).toBe(false)
    expect(newTaskAction?.classList.contains('dream-sidebar-nav-newTask-selected')).toBe(false)
