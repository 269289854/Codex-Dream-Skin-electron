...
export async function compileTheme(
  ...
  return {
    css,
    rendererPayload: JSON.stringify({ version: 16, profile, sidebarNavigation: SIDEBAR_NAV_ITEMS, home: { actions: HOME_ACTIONS }, assets, conversationBackground }).replace(/</g, '\\u003c'),
    assets
  }
}
