...
function registerIpc(): void {
  ...
  ipcMain.handle('project-icons:get-session-icons-enabled', () => captureIpcResult(() => projectIconStore.getSessionIconsEnabled()))
  ipcMain.handle('project-icons:set-session-icons-enabled', (_event, enabled: unknown) => captureIpcResult(() => projectIconStore.setSessionIconsEnabled(enabled)))
  ...
  ipcMain.handle('project-icons:assign-session', (_event, themeId: unknown, projectId: unknown, sessionId: unknown, ref: unknown) => captureIpcResult(() => projectIconStore.assignSession(themeId, projectId, sessionId, ref)))
  ipcMain.handle('project-icons:clear-session-assignment', (_event, themeId: unknown, projectId: unknown, sessionId: unknown) => captureIpcResult(() => projectIconStore.clearSessionAssignment(themeId, projectId, sessionId)))
