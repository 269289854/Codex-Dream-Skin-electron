...
export const PREVIEW_TARGETS = {
  ...
  'conversation-plan-message': styleTarget('生成计划', 'conversation', { colors: ['conversationPlanText', 'conversationPlanLink'], paints: ['conversationPlanMessage', 'conversationPlanMessageHover'], fontSlot: 'ui', visibility: 'conversationBubbles', conversationBubbleRole: 'plan', inspectorAnchor: 'visual-conversation-bubbles' }),
  ...
  'composer-add': styleTarget('添加按钮', 'composer', { colors: ['composerToolIcon'], paints: ['composerToolButton', 'composerToolButtonHover', 'composerToolButtonSelected'], iconSlot: 'composerAdd' }),
  'composer-microphone': styleTarget('麦克风按钮', 'composer', { colors: ['composerToolIcon'], paints: ['composerToolButton', 'composerToolButtonHover', 'composerToolButtonSelected'], iconSlot: 'composerMicrophone' }),
