...
export const APPEARANCE_COLOR_TOKENS = {
  ...
  sidebarNavNewTaskText: colorToken('新对话普通文字', 'sidebar', '--dream-sidebar-nav-new-task-text', 'ink', ['sidebar-nav-new-task']),
  sidebarNavNewTaskHoverText: colorToken('新对话悬停文字', 'sidebar', '--dream-sidebar-nav-new-task-hover-text', 'accent', ['sidebar-nav-new-task'], 'hover'),
  sidebarNavNewTaskSelectedText: colorToken('新对话选中文字', 'sidebar', '--dream-sidebar-nav-new-task-selected-text', 'accent', ['sidebar-nav-new-task'], 'selected'),
