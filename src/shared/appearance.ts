...
export const APPEARANCE_COLOR_TOKENS = {
  ...
  sidebarNavNewTaskText: colorToken('新建任务普通文字', 'sidebar', '--dream-sidebar-nav-new-task-text', 'ink', ['sidebar-nav-new-task']),
  sidebarNavNewTaskHoverText: colorToken('新建任务悬停文字', 'sidebar', '--dream-sidebar-nav-new-task-hover-text', 'accent', ['sidebar-nav-new-task'], 'hover'),
  sidebarNavNewTaskSelectedText: colorToken('新建任务选中文字', 'sidebar', '--dream-sidebar-nav-new-task-selected-text', 'accent', ['sidebar-nav-new-task'], 'selected'),
  sidebarNavPullRequestsText: colorToken('拉取请求普通文字', 'sidebar', '--dream-sidebar-nav-pull-requests-text', 'ink', ['sidebar-nav-pull-requests']),
  sidebarNavPullRequestsHoverText: colorToken('拉取请求悬停文字', 'sidebar', '--dream-sidebar-nav-pull-requests-hover-text', 'accent', ['sidebar-nav-pull-requests'], 'hover'),
  sidebarNavPullRequestsSelectedText: colorToken('拉取请求选中文字', 'sidebar', '--dream-sidebar-nav-pull-requests-selected-text', 'accent', ['sidebar-nav-pull-requests'], 'selected'),
  sidebarNavSitesText: colorToken('站点普通文字', 'sidebar', '--dream-sidebar-nav-sites-text', 'ink', ['sidebar-nav-sites']),
  sidebarNavSitesHoverText: colorToken('站点悬停文字', 'sidebar', '--dream-sidebar-nav-sites-hover-text', 'accent', ['sidebar-nav-sites'], 'hover'),
  sidebarNavSitesSelectedText: colorToken('站点选中文字', 'sidebar', '--dream-sidebar-nav-sites-selected-text', 'accent', ['sidebar-nav-sites'], 'selected'),
  sidebarNavScheduledText: colorToken('已安排普通文字', 'sidebar', '--dream-sidebar-nav-scheduled-text', 'ink', ['sidebar-nav-scheduled']),
  sidebarNavScheduledHoverText: colorToken('已安排悬停文字', 'sidebar', '--dream-sidebar-nav-scheduled-hover-text', 'accent', ['sidebar-nav-scheduled'], 'hover'),
  sidebarNavScheduledSelectedText: colorToken('已安排选中文字', 'sidebar', '--dream-sidebar-nav-scheduled-selected-text', 'accent', ['sidebar-nav-scheduled'], 'selected'),
  sidebarNavPluginsText: colorToken('插件普通文字', 'sidebar', '--dream-sidebar-nav-plugins-text', 'ink', ['sidebar-nav-plugins']),
  sidebarNavPluginsHoverText: colorToken('插件悬停文字', 'sidebar', '--dream-sidebar-nav-plugins-hover-text', 'accent', ['sidebar-nav-plugins'], 'hover'),
  sidebarNavPluginsSelectedText: colorToken('插件选中文字', 'sidebar', '--dream-sidebar-nav-plugins-selected-text', 'accent', ['sidebar-nav-plugins'], 'selected'),
